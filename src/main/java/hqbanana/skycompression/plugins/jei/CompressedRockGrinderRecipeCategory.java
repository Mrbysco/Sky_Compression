...
public class CompressedRockGrinderRecipeCategory implements IRecipeCategory {
	...
	private final String localizedName = I18n.translateToLocalFormatted("jei.sc.recipe.compressedRockGrinder");
	
	public CompressedRockGrinderRecipeCategory(IGuiHelper guiHelper) {
		super();
	...
	public String getUid() {
		return com.bartz24.skyresources.References.ModID + ":compressedRockGrinder";
	}
	...
	public void setRecipe(IRecipeLayout layout, IRecipeWrapper wrapper, IIngredients ingredients)
	{
		...
		layout.getItemStacks().set(SLOT_INPUT_GRINDER, ItemHelper.GetCompressedRockGrinders());
