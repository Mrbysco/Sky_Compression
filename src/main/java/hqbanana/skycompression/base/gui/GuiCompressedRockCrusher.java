package hqbanana.skycompression.base.gui;
...
public class GuiCompressedRockCrusher extends GuiContainer {
	private IInventory playerInv;
	private TileCompressedRockCrusher tile;
	
	public GuiCompressedRockCrusher(IInventory playerInv, TileCompressedRockCrusher te) {
		super(new ContainerCompressedRockCrusher(playerInv, te));
	...
	@Override
	protected void drawGuiContainerBackgroundLayer(float partialTicks, int mousseX, int mouseY) {
		GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
		this.mc.getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID, "textures/gui/compressedrockcrusher.png"));
		this.drawTexturedModalRect(this.guiLeft, this.guiTop, 0, 0, this.xSize, this.ySize);
		GlStateManager.color(1.0f, 1.0f, 1.0f, 1.0f);
		this.mc.getTextureManager().bindTexture(new ResourceLocation(Reference.MOD_ID, "textures/gui/guiicons.png"));
