...
public class BlockCompressedCactus extends BlockCactus{
	...
	public boolean canBlockStay(World worldIn, BlockPos pos)
    {
        ...
        boolean flag = state.getBlock().getTranslationKey().contains("compressedsand");
        boolean flag2 = state.getBlock().getTranslationKey().contains("compressedredsand");
        boolean flag3 = state.getBlock().getTranslationKey().contains("compressedsnad");
        boolean flag4 = state.getBlock().getTranslationKey().contains("compressedredsnad");
